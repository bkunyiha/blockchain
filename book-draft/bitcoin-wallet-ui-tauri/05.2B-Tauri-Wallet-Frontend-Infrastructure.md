...
28. **5.2B: Frontend Infrastructure** ← *You are here*
...
The build configuration is identical to the admin app's (Chapter 4.2B). The `@` alias, Tauri-specific HMR settings, and Bitcoin color palette are shared across both apps.
...
*This chapter has presented the complete frontend infrastructure for the Tauri wallet application. The next chapter, [5.2C](05.2C-Tauri-Wallet-Frontend-Pages.md), covers each of the 7 page components: wallet creation, listing, info, balance, send, history, and settings.*
