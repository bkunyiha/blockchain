...
18. **Chapter 5A: Wallet UI — Complete Code Listings** ← *You are here*
...
## Chapter 5A: Wallet UI — Code Walkthrough

This companion chapter contains **complete, verbatim listings** of the `bitcoin-wallet-ui` source code that Chapter 5 references. The goal is to let you read and understand the code without opening the project repository.

To help you *learn* the code (not just see it), Chapter 5 includes **annotated versions** of key methods with inline explanatory comments. The listings here remain unmodified so you can cross-check against the exact implementation.

---

## How to use this chapter

Each listing below is taken from `bitcoin-wallet-ui/src/*.rs`. When Chapter 5 references a function, it will either:
...
- **Encrypted persistence**: settings and wallet addresses are stored in SQLCipher (Chapter 6).
...
**[← Previous: Wallet UI](04-Wallet-UI.md)** | **[Next: Embedded Database & Persistence →](05-Embedded-Database.md)**
