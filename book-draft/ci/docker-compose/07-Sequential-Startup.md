...
## Chapter 8, Section 7: Sequential Startup
...
> **Methods involved**
> - `wait-for-node.sh` (wait + `PREV_NODE_ADDRESS` emission, [Listing 8.3](01A-Docker-Compose-Code-Listings.md#listing-83-cidocker-composeconfigswait-for-nodesh))
> - `docker-entrypoint.sh` (sequential gating + connect-node resolution, [Listing 8.2](01A-Docker-Compose-Code-Listings.md#listing-82-cidocker-composeconfigsdocker-entrypointsh))
