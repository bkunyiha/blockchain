...
3. **Chapter 3: Web API Architecture** ← *You are here*
   ...
   - [Serde Framework Guide](Serde.md) - Serialization framework ← *You are here*
...
**📚 [← Chapter 2.2: Transaction System](../02-Transaction-System.md)** | **Serde Framework Guide** | **[Chapter 4: Desktop Admin UI →](../../bitcoin-desktop-ui/03-Desktop-Admin-UI.md)** 📚
