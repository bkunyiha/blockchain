...
18. **Chapter 18: Transaction to Block** ← *You are here*
...
# Chapter 18: Transaction to Block (End-to-End Runtime Walkthrough)
...
You have already studied these methods in detail in **Chapter 16 (Consensus and Validation)**; this chapter’s purpose is to show **how we reach them at runtime** from `main`.

---

<div align="center">

**[← Previous: Chapter 17 (Node Orchestration)](08-Node-Orchestration.md)** | **Chapter 18: Transaction to Block (End-to-End)** | **[Next: Chapter 10 (Block Acceptance) →](10-Whitepaper-Step-5-Block-Acceptance.md)**
