...
# Chapter 21A: Network Layer — Code Walkthrough (Network Message Pipeline)
...
>
> **Source:**
> - `NodeContext::process_transaction(...)` (defined in **[Chapter 22: Node Orchestration](../node/README.md)**)
> - `NodeContext::add_block(...)` (acceptance contract: **[Chapter 19: Block Acceptance](../chain/10-Whitepaper-Step-5-Block-Acceptance.md)**)
> - `NodeContext::get_block_hashes(...)`, `NodeContext::get_block(...)` (defined in **[Chapter 22: Node Orchestration](../node/README.md)** and chain chapters)
...
> - `NodeContext::add_block(...)` (**defined earlier**; see **[Chapter 19: Block Acceptance](../chain/10-Whitepaper-Step-5-Block-Acceptance.md)**)
> - Block/tx validation and fork choice (**defined earlier**; see **[Chapter 16: Consensus and Validation](../chain/07-Consensus-and-Validation.md)**)

In this book, the acceptance contract is covered in:

- **[Chapter 19: Block Acceptance (Whitepaper Step 5)](../chain/10-Whitepaper-Step-5-Block-Acceptance.md)**
...
**[← Chapter 30: Network Layer](README.md)** | **Chapter 12.A: Network Layer — Code Walkthrough** | **[Chapter 22: Node Orchestration →](../node/README.md)**
