...
24. <a href="05.1-Wallet-UI-Iced.md">Chapter 5.1: Wallet UI (Iced)</a>
25. **5.1A: Code Listings** ← *You are here*
...
## Chapter 5.1A: Wallet UI (Iced) — Code Walkthrough

This companion chapter contains **complete, verbatim listings** of the `bitcoin-wallet-ui-iced` source code that Chapter 5.1 references. The goal is to let you read and understand the code without opening the project repository.

To help you *learn* the code (not just see it), Chapter 5.1 includes **annotated versions** of key methods with inline explanatory comments. The listings here remain unmodified so you can cross-check against the exact implementation.

---

## How to use this chapter

Each listing below is taken from `bitcoin-wallet-ui-iced/src/*.rs`. When Chapter 5.1 references a function, it will either:
