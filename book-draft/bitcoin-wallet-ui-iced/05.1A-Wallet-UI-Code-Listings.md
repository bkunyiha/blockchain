...
33. <a href="05.1-Wallet-UI-Iced.md">Chapter 27: Wallet UI (Iced)</a>
34. **27A: Code Listings** ← *You are here*
...
# Chapter 27A: Wallet UI (Iced) — Code Walkthrough

This companion chapter contains **complete, verbatim listings** of the `bitcoin-wallet-ui-iced` source code that Chapter 27 references. The goal is to let you read and understand the code without opening the project repository.
...
Each listing below is taken from `bitcoin-wallet-ui-iced/src/*.rs`. When Chapter 27 references a function, it will either:
...
- **Encrypted persistence**: settings and wallet addresses are stored in SQLCipher (Chapter 29).
