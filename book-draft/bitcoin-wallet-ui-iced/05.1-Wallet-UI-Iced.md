...
24. **Chapter 18: Wallet UI (Iced)** ← *You are here*
25. <a href="05.1A-Wallet-UI-Code-Listings.md">18A: Code Listings</a>
...
> **Framework Comparison:** This chapter builds the wallet in pure Rust using Iced. Chapter 19 builds the same wallet using Tauri 2 with a React frontend. Both wallets share the same SQLCipher encrypted database (Chapter 20), so you can see how two different UI frameworks consume identical persistence and API layers.

---

## How to read this chapter (and where the code lives)

All functions referenced in this chapter are defined in [Chapter 18A](05.1A-Wallet-UI-Code-Listings.md).

This chapter explains *how the code works*. The full, verbatim source is in Chapter 18A:
...
- **Initialize persistence**: the encrypted database is created/opened using a password from `generate_database_password` (Listing 18.1). The database itself is explained in Chapter 20.
...
sequenceDiagram
  ...
  participant DB as database.rs (Chapter 20)
...
**[← Previous: Desktop Admin Interface (Tauri)](../bitcoin-desktop-ui-tauri/04.2-Desktop-Admin-UI-Tauri.md)** | **Chapter 18: Wallet User Interface (Iced)** | **[Chapter 18A: Wallet UI (Iced) — Complete Code Listings →](05.1A-Wallet-UI-Code-Listings.md)**
</div>
