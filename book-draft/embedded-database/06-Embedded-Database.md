...
39. **Chapter 29: Embedded Database** ← *You are here*
40. <a href="06A-Embedded-Database-Code-Listings.md">29A: Code Listings</a>
...
# Chapter 29: Embedded Database & Persistence (SQLCipher)

**Part I: Foundations & Core Implementation**

<div align="center">

**[← Chapter 27: Wallet UI (Iced)](../bitcoin-wallet-ui-iced/05.1-Wallet-UI-Iced.md)** | **Chapter 29: Embedded Database** | **[Chapter 30: Web Admin UI →](../bitcoin-web-ui/06-Web-Admin-UI.md)**
</div>
...
To keep this chapter readable without a repository open, the complete, verbatim source files are provided in **[Chapter 29A: Embedded Database — Complete Code Listings](06A-Embedded-Database-Code-Listings.md)**.
...
Complete code listings are in [Chapter 29A](06A-Embedded-Database-Code-Listings.md).
...
- **Tauri wallet**: see [Chapter 19](../bitcoin-wallet-ui-tauri/05.2-Wallet-UI-Tauri.md), with Rust backend details in [Chapter 28A](../bitcoin-wallet-ui-tauri/05.2A-Tauri-Wallet-Rust-Backend.md)

---

<div align="center">

**[← Previous: Wallet UI (Tauri)](../bitcoin-wallet-ui-tauri/05.2-Wallet-UI-Tauri.md)** | **Chapter 29: Embedded Database & Persistence** | **[Next: Web Admin Interface →](../bitcoin-web-ui/06-Web-Admin-UI.md)**
</div>
