...
30. <a href="06-Embedded-Database.md">Chapter 20: Embedded Database</a>
31. **20A: Code Listings** ← *You are here*
...
## Chapter 20A: Embedded Database — Complete Code Listings

This companion chapter contains **complete, verbatim listings** of the SQLCipher persistence module from both wallet applications. Chapter 20 contains the **annotated walkthroughs** with explanatory comments. The listings here are reproduced unmodified so you can cross-check against the exact implementation.
