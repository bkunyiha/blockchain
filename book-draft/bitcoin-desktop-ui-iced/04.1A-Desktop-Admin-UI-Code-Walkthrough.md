...
## Code Listing 4A-2 — Tokio runtime bridge (`bitcoin-desktop-ui-iced/src/runtime.rs`)
...
## Code Listing 4A-6 — Navigation + events (`bitcoin-desktop-ui-iced/src/types.rs`)
...
## Code Listing 4A-16 — Async API client helpers (`bitcoin-desktop-ui-iced/src/api.rs`)
