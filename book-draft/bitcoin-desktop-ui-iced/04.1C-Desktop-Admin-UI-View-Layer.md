...
28. **25C: View Layer** ← *You are here*
...
# Chapter 25C — Desktop Admin Interface (Iced): the View Layer (`view.rs`)
...
## Listing 16C-1.1 — `view.rs` (full listing)
...
**[← Chapter 25B](04.1B-Desktop-Admin-UI-Update-Loop.md)** | **Chapter 25C** | **[Next: Chapter 26 (Desktop UI - Tauri) →](../bitcoin-desktop-ui-tauri/04.2-Desktop-Admin-UI-Tauri.md)**
