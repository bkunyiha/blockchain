...
16. <a href="04.1-Desktop-Admin-UI-Iced.md">Chapter 4.1: Desktop Admin (Iced)</a>
...
19. **4.1C: View Layer** ← *You are here*
...
# Chapter 4.1C — Desktop Admin Interface (Iced): the View Layer (`view.rs`)
...
**📚 [← Chapter 4.1B](04.1B-Desktop-Admin-UI-Update-Loop.md)** | **Chapter 4.1C** | **[Next: Chapter 4.2 (Desktop UI - Tauri) →](../bitcoin-desktop-ui-tauri/04.2-Desktop-Admin-UI-Tauri.md)** 📚
