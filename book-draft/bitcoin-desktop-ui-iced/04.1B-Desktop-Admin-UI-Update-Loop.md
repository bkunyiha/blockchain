...
18. **4.1B: Update Loop** ← *You are here*
...
# Chapter 4.1B — Desktop Admin Interface (Iced): the Update Loop (`update.rs`)
...
> - `spawn_on_tokio(...)` (defined in Chapter 4.1A)
> - API helpers from `api.rs` (defined in Chapter 4.1A)
> - `AdminApp::clear_related_data(...)` (defined in Chapter 4.1A)
...
**📚 [← Chapter 4.1A](04.1A-Desktop-Admin-UI-Code-Walkthrough.md)** | **Chapter 4.1B** | **[Next: Chapter 4.1C (View Layer) →](04.1C-Desktop-Admin-UI-View-Layer.md)** 📚
